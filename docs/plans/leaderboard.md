...
| v0.12-run15 | 2026-06-13 | 6 | `output/adapter_v12_run15` | 600 steps (active) | 32 | 2e-4 | 4096 | No | — | — | — | — | pending | DGX Spark GB10; warmstart run14 step-300 (0.64); v0.12 data 15,502 examples (seq=4096 filter); 878M trainable; lr=2e-4 (up from 1e-4 to escape run14 plateau); checkpoint every 100 steps |
