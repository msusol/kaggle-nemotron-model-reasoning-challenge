...
| v0.13-run16 | 2026-06-13 | 6 | `output/adapter_v13_run16_ckpt` | active | 32 | 1e-4 | 4096 | No | — | — | — | — | active | DGX Spark GB10; warmstart run15-step200; v0.13 data 11,300 rows (balanced, all ≤4096 tok); 13 categories; lr=1e-4; checkpoint every 100 steps |
