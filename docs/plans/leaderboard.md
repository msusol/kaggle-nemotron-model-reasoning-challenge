...
| v0.4-huikang-r2 | 2026-06-02 | 5 | `output/adapter_huikang_v4_20260601_194000` | 1 | 32 | 2e-4 | 8192 | No | 0.221 | — | 0.2072 | *pending inference* | *pending* | System prompt fix applied (`get("system") or SYSTEM_PROMPT`); 948 steps / 14.2 h; eval token acc 94.57%; \boxed{–} still in training data |
