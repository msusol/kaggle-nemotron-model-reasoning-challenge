...
| v0.9-run6 | 2026-06-10 | 6 | `adapters/adapter_v9_run6` | 1 epoch (~495 steps) | 32 | 2e-4 | 4096 | No | — | — | — | — | *pending* | Kaggle RTX Pro 6000; fresh start (no warmstart); 9 LoRA targets incl. in_proj/out_proj for 23 Mamba SSM layers; ~510 keys; ≤4096 token examples (~58% of dataset) |
