...
| v0.9-run12-moe | *in progress* | 6 | `output/adapter_v9_run12` | 1000 steps (150 done) | 32 | 2e-4 | 2048 | No | 0.1948 @ step 150 | — | — | — | *pending* | DGX Spark GB10; first run with per-expert MoE LoRA working — 883,873,792 trainable (2.72%) vs 27.7M in runs 9–11; fix: re-enable requires_grad after Unsloth's prepare_model_for_training freezes lora_A_up/B_up/etc; out_proj LoRA confirmed dead (Mamba fast-path bypass); ~25h run |
