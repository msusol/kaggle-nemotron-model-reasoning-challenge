...
| v0.5-sft-merged | 2026-06-03 | 5 | `output/adapter_v5_sft_merged` | 240 steps | 32 | 2e-4 | 6144 | No | 0.5441 | 87.2% | — | — | *pending* | Same training + v27 Unsloth keys merged back (464 keys, 1.58 GB); fix baked into train_v5_sft.py for future runs |
