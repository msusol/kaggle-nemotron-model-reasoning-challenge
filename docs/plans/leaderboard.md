...
| v0.9-run13-step100 | 2026-06-11 | 6 | `output/adapter_v9_run13_ckpt` | 100 steps (of 1000) | 32 | 2e-4 | 2048 | No | 0.2211 @ step 100 | — | — | — | 0.45 | DGX Spark GB10; fresh start (no warmstart); 878,880,768 trainable (2.71%); **first submission with 11,776 per-expert PEFT keys** — regression vs run12 (0.55) likely due to undertrained expert LoRA at step 100 (lora_B max=0.035, adding noise); canary test for key-format path |
| v0.9-run13-step500 | 2026-06-12 | 6 | `output/adapter_v9_run13/checkpoint-500` | 500 steps (of 1000) | 32 | 2e-4 | 2048 | No | 0.1864 @ step 500 (epoch boundary) / 0.1575 @ ~508 | — | — | — | **0.58** | DGX Spark GB10; 878M trainable; 11,776 per-expert PEFT keys; epoch 2 complete; **new overall best** — confirms per-expert PEFT path works in Kaggle evaluator |
| v0.9-run13-step600 | 2026-06-12 | 6 | `output/adapter_v9_run13/checkpoint-600` | 600 steps (of 1000) | 32 | 2e-4 | 2048 | No | 0.1702 @ step 600 / best obs 0.1511 @550 / ~0.14 @~559 | — | — | — | 0.55 | DGX Spark GB10; 878M trainable; 11,776 per-expert PEFT keys; epoch 2.46; lower than step-500 despite better train loss — possible overfit oscillation at ckpt boundary |
| v0.9-run13-step700 | 2026-06-12 | 6 | `output/adapter_v9_run13/checkpoint-700` | 700 steps (of 1000) | 32 | 2e-4 | 2048 | No | 0.1380 @ step 700 (new best ckpt) | — | — | — | 0.57 | DGX Spark GB10; 878M trainable; 11,776 per-expert PEFT keys; epoch 2.872; below step-500 (0.58) — epoch-boundary checkpoints generalize better despite higher train loss |
| v0.9-run13-step800 | 2026-06-12 | 6 | `output/adapter_v9_run13/checkpoint-800` | 800 steps (of 1000) | 32 | 2e-4 | 2048 | No | 0.1265 @ step 800 (best ckpt) | — | — | — | pending | DGX Spark GB10; 878M trainable; 11,776 per-expert PEFT keys; best checkpoint train loss — submitted, score pending |
| v0.9-run13-step1000 | 2026-06-13 | 6 | `output/adapter_v9_run13_ckpt` | 1000 steps (final) | 32 | 2e-4 | 2048 | No | 0.1220 @ step 1000 (epoch 4.099) | — | — | — | 0.49 | DGX Spark GB10; 878M trainable; 11,776 per-expert PEFT keys; final checkpoint; LR decayed to ~0; overfit past step-500 (0.58 → 0.49 at step-1000) |
| v0.12-run14-step300 | 2026-06-13 | 6 | `output/adapter_v12_spark_ckpt` | 300 steps (stopped early) | 32 | 1e-4 | 4096 | No | ~0.285 (plateau from step 80) | — | — | — | **0.64** | DGX Spark GB10; warmstart run13 step-1000; v0.12 data 25,500 rows (15,502 after seq=4096 filter); 878M trainable; 11,962 expert LoRA keys; loss plateaued at ~0.285 since step 80 — stopped at step 300; **new overall best** (+0.06 vs run13-step500) |
| v0.12-run15-step100 | 2026-06-13 | 6 | `output/adapter_v12_run15_step100` | 100 steps | 32 | 2e-4 | 4096 | No | 0.2738 @ step 100 | — | — | — | 0.64 | DGX Spark GB10; warmstart run14 step-300; lr=2e-4 raised to escape run14 plateau; loss plateau from step 50 onward (no downward trend); matches run14 best |
| v0.12-run15-step200 | 2026-06-13 | 6 | `output/adapter_v12_run15_step200` | 200 steps (final) | 32 | 2e-4 | 4096 | No | 0.2823 @ step 200 | — | — | — | 0.64 | DGX Spark GB10; stopped at step 200 to preserve GPU time for run16; warmstart for run16; same score as run14 — lr=2e-4 produced no improvement over run14 plateau |
| v0.13-run16 | 2026-06-13 | 6 | — | 17 steps (skipped) | 32 | 1e-4 | 4096 | No | — | — | — | — | — | DGX Spark GB10; warmstart run15-step200; v0.13 data 11,300 rows; stopped at step 17 — v0.13 dataset dropped 3 categories entirely (equation_numeric_deduce, equation_numeric_guess, spelling all exceed 4096 tok); pivoted to v0.14 |
| v0.14-run17-step100 | 2026-06-14 | 6 | `output/adapter_v14_run17/checkpoint-100` | 100 steps (of 500) | 32 | 1e-4 | 4096 | No | 0.2374 @ step 100 | — | — | — | **0.67 ★** | DGX Spark GB10; warmstart run15-step200; v0.14 data 12,800 rows (all 16 categories); 11,962 expert LoRA keys; lr=8.9e-05 @ step 100; **new overall best** (+0.03 vs v0.12) |
| v0.14-run17-step200 | 2026-06-14 | 6 | `output/adapter_v14_run17/checkpoint-200` | 200 steps (of 500) | 32 | 1e-4 | 4096 | No | 0.2630 @ step 200 | — | — | — | 0.66 | DGX Spark GB10; warmstart run15-step200; v0.14 data 12,800 rows (all 16 categories); 11,962 expert LoRA keys; lr=6.7e-05 @ step 200 |
| v0.14-run17-step300 | 2026-06-14 | 6 | `output/adapter_v14_run17/checkpoint-300` | 300 steps (of 500) | 32 | 1e-4 | 4096 | No | 0.2465 @ step 300 | — | — | — | **0.67 ★** | DGX Spark GB10; warmstart run15-step200; v0.14 data 12,800 rows (all 16 categories); 11,962 expert LoRA keys; lr=4.5e-05 @ step 300; tied overall best |
| v0.14-run17-step400 | 2026-06-15 | 6 | `output/adapter_v14_run17/checkpoint-400` | 400 steps (of 500) | 32 | 1e-4 | 4096 | No | 0.2400 @ step 400 | — | — | — | 0.66 | DGX Spark GB10; warmstart run15-step200; v0.14 data 12,800 rows (all 16 categories); 11,962 expert LoRA keys; lr=2.2e-05 @ step 400 |
| v0.14-run17-step500 | 2026-06-15 | 6 | `output/adapter_v14_run17/checkpoint-500` | 500 steps — **FINAL** | 32 | 1e-4 | 4096 | No | 0.2679 @ step 500 | — | — | — | **0.67 ★** | DGX Spark GB10; warmstart run15-step200; v0.14 data 12,800 rows (all 16 categories); 11,962 expert LoRA keys; lr~0 @ step 500; run complete 2026-06-15; tied overall best |
