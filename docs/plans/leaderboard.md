...
| v0.9-kaggle-run6 | *pending* | 6 | `adapters/adapter_v9_kaggle_run6` | 1 epoch (~822 steps) | 32 | 2e-4 | 4096 | No | — | — | — | — | — | Kaggle RTX Pro 6000; ALL examples ≤4096 tokens (~13,158 of 13,730); warmstart run5; aligned with evaluator max_model_len=4096; evaluator uses vLLM + enable_thinking=True |
