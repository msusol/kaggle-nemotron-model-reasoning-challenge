...
#
# Usage:
#   bash scripts/build_image.sh                    # build primary image (Dockerfile.gb10, 26.01)
#   bash scripts/build_image.sh 25                 # build archived 25.12 image (Dockerfile.gb10-25)
