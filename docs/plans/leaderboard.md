...
| v0.9-kaggle-run4 | 2026-06-09 | 6 | `adapters/adapter_v9_kaggle_run4` | 1 epoch (~244 steps) | 32 | 2e-4 | 2048 | No | — | — | — | — | *pending* | Kaggle RTX Pro 6000 (kernel v85); full short-example epoch, warmstart run3; rglob name-match fix applied; 140 keys (48 attn + 92 shared_experts) |
