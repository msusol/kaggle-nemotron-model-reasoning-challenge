...
| v0.9-run13-step1000 | 2026-06-13 | 6 | `output/adapter_v9_run13_ckpt` | 1000 steps (final) | 32 | 2e-4 | 2048 | No | 0.1220 @ step 1000 (epoch 4.099) | — | — | — | pending | DGX Spark GB10; 878M trainable; 11,776 per-expert PEFT keys; final checkpoint; LR decayed to ~0; submitted, score pending |
| v0.12-run14-step300 | 2026-06-13 | 6 | `output/adapter_v12_spark_ckpt` | 300 steps (stopped early) | 32 | 1e-4 | 4096 | No | ~0.285 (plateau from step 80) | — | — | — | pending | DGX Spark GB10; warmstart run13 step-1000; v0.12 data 25,500 rows (15,502 after seq=4096 filter); 878M trainable; 11,962 expert LoRA keys; loss plateaued at ~0.285 since step 80 — stopped at step 300 to avoid 7h of wasted compute; submitted 2026-06-13 |
