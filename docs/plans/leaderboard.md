...
| v0.9-kaggle-run6 | 2026-06-09 | 6 | `adapters/adapter_v9_kaggle_run6` | 1 epoch (~822 steps) | 32 | 2e-4 | 4096 | No | — | — | — | — | *pending* | Kaggle RTX Pro 6000 (kernel v88); 13,158 examples ≤4096 tokens (95.8% of dataset); warmstart run5; 140 keys; submission blocked by daily limit — submit 2026-06-10 |
