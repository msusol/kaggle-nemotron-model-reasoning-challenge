...
| v0.4-huikang | 2026-06-01 | 5 | `output/adapter_huikang_v4_20260531_191344` | 1 | 32 | 2e-4 | 8192 | No | 0.2217 | 94.27% | 0.2092 | *pending inference* | *pending* | First complete v0.4 run — 948 steps / 14.4 h; eval token acc 94.47%; GC disabled (NemotronH unsupported); page-cache warm load |
