...
| v0.9-kaggle-run1 | 2026-06-08 | 6 | `adapters/adapter_v9_kaggle_run1` | 200 steps | 32 | 2e-4 | 2048 | No | — | — | — | — | *pending* | Kaggle RTX Pro 6000 committed run (kernel v61); 1000-sample subset, fresh base-model init; 48.2 min training; GC fix: gradient_checkpointing=True in SFTConfig |
| v0.9-kaggle-run2 | *running* | 6 | *pending* | 1 epoch | 32 | 2e-4 | 2048 | No | — | — | — | — | — | Kaggle RTX Pro 6000 (kernel v63); full dataset (None records), warmstart from run1 adapter; MAX_STEPS=None |
