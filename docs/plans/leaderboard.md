...
| v0.4-huikang-v26 | 2026-06-02 | 5 | `output/adapter_huikang_v26` | — | 32 | 2e-4 | 8192 | No | — | — | — | — | *pending* | Downloaded kuangyicheng adapter_v26 (all-linear, 1.5 GB); baseline score check before GRPO |
| v0.5-grpo | *pending* | 6 | *pending* | 1–2 | 32 | 1e-6 | 4096 | No | — | — | — | — | — | GRPO init from adapter_huikang_v26; target_modules=all-linear; 9,500 competition problems |
