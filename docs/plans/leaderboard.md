...
| v0.9-kaggle-run5 | 2026-06-09 | 6 | `adapters/adapter_v9_kaggle_run5` | 1 epoch (593 steps) | 32 | 2e-4 | 7680 | No | — | — | — | — | *pending* | Kaggle RTX Pro 6000 (kernel v87); 9502 long examples (MIN_SEQ_LENGTH=2048), warmstart run4; 135.0 min, 13.7 s/step; 140 keys (48 attn + 92 shared_experts); submission blocked by daily limit — submit 2026-06-10 |
| v0.9-run6 | 2026-06-10 | 6 | `adapters/adapter_v9_run6` | 1 epoch (~495 steps) | 32 | 2e-4 | 4096 | No | — | — | — | — | *pending* | Kaggle RTX Pro 6000; fresh start (no warmstart); 9 LoRA targets incl. in_proj/out_proj for 23 Mamba SSM layers; 278 keys (all standard PEFT lora_A/B; routed expert target_parameters not captured in adapter save — see docs/investigate/routed-expert-lora-capture.md); ≤4096 token examples (~58% of dataset) |
